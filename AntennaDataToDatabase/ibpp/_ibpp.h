...
#pragma warning(disable : 4250)
    struct DebugStream : public std::stringstream
    {
        ...
        {
            static_cast<std::stringstream&>(*this) << p;
            return *this;
        }
    ...
    struct DebugStream
    {
        template<class T> DebugStream& operator<< (const T&)
        {
            return *this;
        }
        // for manipulators
...
//
    ...
    public:
        ...
        bool Errors()
        {
            return (mVector[0] == 1 && mVector[1] > 0) ? true : false;
        }
        const char* ErrorMessage() const;
        int SqlCode() const;
        int EngineCode() const
        {
            return (mVector[0] == 1) ? (int)mVector[1] : 0;
        }
        void Reset();
...
//
    ...
    */
    ...
    public:
        ...
        const char* CreateParams() const
        {
            return mCreateParams.c_str();
        }
    ...
    public:
        ...
        inline void CursorExecute(const std::string& cursor)
        {
            CursorExecute(cursor, std::string());
        }
        bool Fetch();
        bool Fetch(IBPP::Row&);
        int AffectedRows();
...
//
    ...
    public:
        ...
        {
            mIt += 1 + static_cast<int>(*mIt) + 4;
            return *this;
        }

        bool operator == (const EventBufferIterator& i) const
        {
            return i.mIt == mIt;
        }
        bool operator != (const EventBufferIterator& i) const
...
#pragma warn .8027
        ...
        It end()
        {
            return mIt + 1 + static_cast<int>(*mIt) + 4;
        }
